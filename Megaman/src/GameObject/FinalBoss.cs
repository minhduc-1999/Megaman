        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (!attackType[attackIndex].Equals("NONE"))
            {
                ...
                else if (attackType[attackIndex].Equals("slide"))
                {
                    ...
                    if (getGameWorld().physicalMap.haveCollisionWithLeftWall(getBoundForCollisionWithMap()) != Rectangle.Empty)
                        setSpeedX(5);
                    if (getGameWorld().physicalMap.haveCollisionWithRightWall(getBoundForCollisionWithMap()) != Rectangle.Empty)
                        setSpeedX(-5);
